        ...
        <div x-show="isOpen" x-transition:enter="ease-out duration-200"
            ...
            <div class="relative">
                ...
                <input @keydown.tab.prevent="" @keydown.prevent.stop.enter="go()" @keydown.prevent.arrow-up="selectUp()"
                       ...
                       class="ring-brand-500 appearance-none w-full bg-transparent px-6 py-4 text-gray-300 text-lg placeholder-gray-500 focus:border-0 focus:border-transparent focus:shadow-none outline-none focus:outline-none"
