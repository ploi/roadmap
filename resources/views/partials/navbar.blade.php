        ...
        <div class="overflow-y-auto space-y-4">
            <ul class="space-y-2">
                <li>
                    <a
                        @class([
                                'flex items-center h-10 px-2 space-x-2 transition rounded-lg dark:text-gray-200',
                                'text-white bg-brand-500 dark:bg-white/5 dark:hover:bg-white/5 dark:text-brand-500' => request()->is('/'),
                                'hover:bg-gray-500/5 focus:bg-brand-500/10 focus:text-brand-600 focus:outline-none dark:hover:bg-white/5 dark:focus:text-gray-200' => !request()->is('/')
                            ])
                        href="{{ route('home') }}">
                ...
                <li>
                    <a
                        @class([
                            ...
                            'hover:bg-gray-500/5 focus:bg-brand-500/10 focus:text-brand-600 focus:outline-none dark:hover:bg-white/5 dark:focus:text-gray-200' => !request()->is('my')
                        ])
                        href="{{ route('my') }}">
                ...
                <li>
                    <a
                        @class([
                            ...
                            'hover:bg-gray-500/5 focus:bg-brand-500/10 focus:text-brand-600 focus:outline-none dark:hover:bg-white/5 dark:focus:text-gray-200' => !request()->is('profile')
                        ])
                        href="{{ route('profile') }}">
                    ...
                    <li>
                        <a
                            @class([
                                ...
                                'hover:bg-gray-500/5 focus:bg-brand-500/10 focus:text-brand-600 focus:outline-none dark:hover:bg-white/5 dark:focus:text-gray-200' => !request()->is('changelog*')
                            ])
                            ...
                            @foreach($projects as $project)
                                <li>
                                    <a
                                       ...
                                       'hover:bg-gray-500/5 focus:bg-brand-500/10 focus:text-brand-600 focus:outline-none dark:hover:bg-white/5 dark:focus:text-gray-200' => request()->segment(2) !== $project->slug
                                   ])
