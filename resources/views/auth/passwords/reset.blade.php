            ...
            <div class="w-full max-w-md px-4 mx-auto sm:px-6 md:px-8">
                ...
                <form class="mt-8 space-y-6 md:mt-12"
                    ...
                    <div x-data="{ show: false }" class="space-y-2">
                        ...
                        <div class="flex items-center w-full h-10 bg-white transition dark:bg-gray-900 dark:border-white/10 duration-75 border-gray-300 rounded-lg shadow-sm focus:border-brand-600 focus:ring-1 focus:ring-inset focus:ring-brand-600">
                            <input
                                :type="show ? 'text' : 'password'"
                                class="flex-1 h-full px-2.5 bg-white transition dark:bg-gray-900 dark:border-white/10 duration-75 border-gray-300 rounded-lg shadow-sm focus:ring-1 focus:ring-inset focus:ring-brand-600 focus:border-brand-600"
                                id="password"
                                required
                                autofocus
                                name="password">
